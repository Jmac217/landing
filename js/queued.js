$(document).ready(function() {
    ...
    $('#tracker_documentation_collapse').click(function() {
        $('#tracker_documentation').animate({
            'height': '35px'
        });
        $('#tracker_todo').animate({
            'top': '20px',
            'height': '390px'
        });
        $('#tracker_notes').animate({
            'height': '360px'
        });
        $('#tracker_notes_body').animate({
            'height': '330px'
        });
        $('#tracker_documentation_collapse').css({
            'visibility': 'hidden'
        });
        $('#tracker_documentation_expand').css({
            'visibility': 'visible'
        });
        $('#tracker_top').css({
            'visibility': 'hidden'
        ...
        setTimeout(function() {
            $('#tracker_documentation_head').css({
                'visibility': 'hidden'
            });
            $('#tracker_documentation_body').css({
                'visibility': 'hidden'
            });
        }, 370);
    });
